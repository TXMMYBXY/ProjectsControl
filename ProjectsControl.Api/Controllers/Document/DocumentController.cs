...
using ProjectsControl.Api.Controllers.Auth;
...
namespace ProjectsControl.Api.Controllers.Document;

[ApiController]
[Route("api/document")]
[AuthorizeByRole((int)Role.Boss, (int)Role.Manager, (int)Role.Manager)]
